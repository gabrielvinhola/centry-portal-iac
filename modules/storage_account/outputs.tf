...
output "file_shares" {
  ...
  value       = { for f in azurerm_storage_share.this : f.name => f.id }
}

output "tables" {
  description = "Map of Storage SMB file shares."
  value       = { for t in azurerm_storage_table.this : t.name => t.id }
}

output "queues" {
  description = "Map of Storage SMB file shares."
  value       = { for q in azurerm_storage_queue.this : q.name => q.id }
}